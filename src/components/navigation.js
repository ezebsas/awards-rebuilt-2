...
import { Nav, NavHeader, CloseNav, NavFooter, NavList, NavVideos } from '../styles/navigationStyles'
            ...
            <Container>
              <NavHeader>
                <Flex spaceBetween noHeight>
                  <h2>Projects</h2>
                  <CloseNav onClick={() => setToggleMenu(false)} onMouseEnter={() => onCursor('pointer')} onMouseLeave={onCursor}>
                    <button>
                      <span></span>
                      <span></span>
                    </button>
